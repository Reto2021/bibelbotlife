...
const ConnectChatGPT = lazy(() => import("./pages/ConnectChatGPT"));
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/guide/discord-integration" element={<GuideDiscordIntegration />} />
                   ...
                   <Route path="/connect" element={<ConnectChatGPT />} />
                  ...
                  <Route path="/mein-bereich" element={<ProtectedRoute><MeinBereich /></ProtectedRoute>}>
                    ...
                    <Route path="gedaechtnis" element={<GedaechtnisPage />} />
                  </Route>
                  ...
                  <Route path="/admin/outreach/logs" element={<ProtectedAdminRoute><OutreachLogs /></ProtectedAdminRoute>} />
                  <Route path="/admin/prayers" element={<ProtectedAdminRoute><PrayerModeration /></ProtectedAdminRoute>} />
                  <Route path="/admin/kreuzwege" element={<ProtectedAdminRoute><CrossModeration /></ProtectedAdminRoute>} />
