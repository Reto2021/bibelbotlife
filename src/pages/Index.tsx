    ...
    <div className="min-h-screen" style={{ background: "var(--gradient-hero)" }}>
      ...
      <section className="py-20 px-4" style={{ backgroundImage: "var(--gradient-cta)" }}>
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <Button size="lg" className="bg-card text-foreground hover:bg-card/90 px-8 py-4 text-lg font-semibold" onClick={() => { window.scrollTo({ top: 0, behavior: "smooth" }); setTimeout(() => openBibleBotChat(), 400); }}>
