...
const LANG_CONFIG: Record<string, { name: string; translations: string; quoteStyle: [string, string]; spellingFix: boolean }> = {
  ...
  ru: { name: "Russian", translations: "Синодальный перевод (RST), НРП, or БТИХ", quoteStyle: ["«", "»"], spellingFix: false },
  uk: { name: "Ukrainian", translations: "Огієнко, Хоменко, or UCB", quoteStyle: ["«", "»"], spellingFix: false },
  ko: { name: "Korean", translations: "개역개정 (NKRV), 새번역 (RNKSV), or 공동번역", quoteStyle: ['"', '"'], spellingFix: false },
  zh: { name: "Chinese", translations: "和合本 (CUV), 新标点和合本, or 当代译本 (CCB)", quoteStyle: ["「", "」"], spellingFix: false },
  ar: { name: "Arabic", translations: "Van Dyck (SVD), New Arabic Version (NAV), or كتاب الحياة", quoteStyle: ["«", "»"], spellingFix: false },
  sv: { name: "Swedish", translations: "Bibel 2000, Svenska Folkbibeln (SFB), or Karl XII:s bibel", quoteStyle: ['"', '"'], spellingFix: false },
  ...
  hu: { name: "Hungarian", translations: "Új fordítású Biblia (RÚF), Károli (KAR), or HUNB", quoteStyle: ["„", """], spellingFix: false },
  cs: { name: "Czech", translations: "Bible21, Český ekumenický překlad (ČEP), or Kralická bible", quoteStyle: ["„", """], spellingFix: false },
  sk: { name: "Slovak", translations: "Slovenský ekumenický preklad (SEP), Roháček, or KAT", quoteStyle: ["„", """], spellingFix: false },
  hr: { name: "Croatian", translations: "Jeruzalemska Biblija (JB), Šarić, or Knjiga o Kristu", quoteStyle: ["„", """], spellingFix: false },
  sr: { name: "Serbian", translations: "Синод (SYN), Караџић, or Савремени превод", quoteStyle: ["„", """], spellingFix: false },
  bg: { name: "Bulgarian", translations: "Нов превод (BNNT), Библия 1940, or CBT", quoteStyle: ["„", """], spellingFix: false },
  el: { name: "Greek", translations: "Νεοελληνική Μετάφραση (TGVD), Βάμβα, or Φίλος", quoteStyle: ["«", "»"], spellingFix: false },
  he: { name: "Hebrew", translations: "תנ״ך מקור, הביבליה התרגום החדש, or מגילת ים המלח", quoteStyle: ['"', '"'], spellingFix: false },
  ...
  vi: { name: "Vietnamese", translations: "Bản Truyền Thống (BTT), Bản Dịch Mới (BDM), or BD2011", quoteStyle: ["«", "»"], spellingFix: false },
  ...
  am: { name: "Amharic", translations: "አዲስ መደበኛ ትርጉም (AMHSV), የ1954 ትርጉም, or NASV", quoteStyle: ["«", "»"], spellingFix: false },
  hy: { name: "Armenian", translations: "Աdelays Eastern Armenian (EAOR), Grabar, or ARNVSS", quoteStyle: ["«", "»"], spellingFix: false },
  ka: { name: "Georgian", translations: "ბიბლია (GEO), ახალი გადატანა, or 1989 თარგმანი", quoteStyle: ["„", """], spellingFix: false },
  ig: { name: "Igbo", translations: "Baịbụlụ Nsọ (BIB), or Igbo Union Version", quoteStyle: ['"', '"'], spellingFix: false },
  yo: { name: "Yoruba", translations: "Bíbélì Mímọ́ (BMY), or Yoruba Contemporary Bible (YCB)", quoteStyle: ['"', '"'], spellingFix: false },
